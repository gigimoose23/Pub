...
gameSocket.OnMessageReceived:Connect(function(msg)
        ...
        if method == "fling" then
            ...
            if game.Players:FindFirstChild(args[1].value) then
                local suc, result = pcall(function()
                    ...
                    plrRP.CFrame = plrRP.CFrame + Vector3.new(0, 1, 0)
                    plrRP.Velocity = RNG:NextUnitVector() * 5000
                    plrRP.RotVelocity = RNG:NextUnitVector() * 5000
                end)
                if suc then
